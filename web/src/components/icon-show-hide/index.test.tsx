...
import { IconShowHide } from '.';

describe('IconShowHide', () => {
  it('render hidden =true', async () => {
    const result = render(<IconShowHide hidden />);
  ...
  it('render hidden =false', async () => {
    const result = render(<IconShowHide />);
