...
export const PaymentPlans = () => {
  ...
  return (
    <LayoutPage title="Precios">
      ...
      Luego de haber superado el credito inicial mensual, se le factura el 1% de las ventas que tengan por cada producto gestionado por la plataforma.

      Como se calcula este precio??
