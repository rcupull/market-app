          ...
          items={[
            {
              ...
              items: [
                <><Link to="/docs/business-config-wizard">Usar el asistente automático para realizar la configuracion básica de mi negocio.</Link> (Recomendado para usuarios sin experiencia.)</>,
                <><Link to="/docs/business-config-manual">Configurar un negocio manualmente desde el cero.</Link></>,
              ],
            },
            {
              title: 'Como cambiar el logo de un negocio',
              items: [
                <>En el paner de control de tu negocio</>,
              ],
            }
          ]}
        />
