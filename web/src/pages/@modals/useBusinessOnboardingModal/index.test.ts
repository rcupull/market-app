...
import { useBusinessOnboardingModal } from '.';
      ...
      expect(screen.getByTestId('Modal')).toMatchInlineSnapshot(`
        ...
        >
          ...
          >
            ...
            >
              <div
                class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-11/12 md:w-8/12 lg:w-8/12 w-[98vw] !sm:w-[80vw]"
                data-headlessui-state="open"
                data-open=""
