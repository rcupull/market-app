  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-2 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 className="m-0 sm:mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
          Registrarse
        </h2>
      </div>

      <div className="mt-2 sm:mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <Formux
          value={{
            email: '',
            password: '',
