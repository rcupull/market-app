...
import { usePrivacyPolicyModal } from '.';
      ...
      expect(screen.getByTestId('Modal')).toMatchInlineSnapshot(`
        ...
        >
          ...
          >
            ...
            >
              <div
                class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-11/12 md:w-8/12 lg:w-8/12 !w-[95vw] !sm:w-[80vw]"
                data-headlessui-state="open"
                data-open=""
              ...
              >
                ...
                >
                  <button
                    class="relative px-3 py-1.5 text-sm shadow-sm font-semibold rounded-md flex items-center justify-center leading-6 whitespace-nowrap h-fit bg-transparent text-gray-600 fill-gray-600 ring-2 ring-gray-300 hover:bg-gray-100 ml-auto"
                  >
                    Cerrar
                  </button>
                </div>
