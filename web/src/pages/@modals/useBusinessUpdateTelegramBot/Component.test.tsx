...
describe('Component', () => {
  it('render', async () => {
    ...
    expect(result.container).toMatchInlineSnapshot(`
      <div>
        <div>
          Nuestra plataforma utiliza Telegram para mantenerlo actualizado del estado de sus negocios, órdenes de compra y otras informaciones importantes. Continue los siguientes pasos para
           
          <span
            class="font-bold"
          >
            activar su cuenta de Telegram en este negocio
          </span>
          .
          <div
